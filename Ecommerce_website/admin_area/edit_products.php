...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data" class="w-50 m-auto">
        ...
        <label for="product_brands" class="form-label">Product Brands</label>
           <select name="product_brands" class="form-select" value="<?php echo $product_brand?>">
        ...
        <div class="text-center">
            <input type="submit" name="edit_product" id="" value="Update product" class="btn btn-info px-3 mb-3">
        </div>
    </form>
</div>
...
if(isset($_POST['edit_product'])){
    ...
    // checking for filled is empty or not
    if($product_title=='' or $product_desc=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_image1=='' or $product_image2=='' or $product_image3=='' or $product_price=='') {
        echo "<script>alert('Please filled all the fields and continue the process')</script>";
    }
    else {
